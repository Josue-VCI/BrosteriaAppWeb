export const WORLD_CUP_TEMPLATE = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #0b0b0c; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.15); border: 1px solid #27272a;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; background-color: #121214;">
                            ...
                            <!-- Combo 1 -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px; background-color: #1c1c1f; border-radius: 12px; border: 1px solid #27272a;">
                                <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="90" align="right" valign="middle">
                                                    <span style="color: #FFB703; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;">S/. 15.00</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <!-- Combo 2 -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 25px; background-color: #1c1c1f; border-radius: 12px; border: 1px solid #27272a;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td>
                                                    <span style="background-color: #00C853; color: #ffffff; font-size: 11px; font-weight: bold; padding: 4px 10px; border-radius: 50px; text-transform: uppercase; font-family: sans-serif;">Familiar Especial </span>
                                                    <h4 style="color: #ffffff; font-size: 16px; margin: 10px 0 5px 0; font-family: Arial, sans-serif;">Combo La Jugada Familiar </h4>
                                                    <p style="color: #a0a0a8; font-size: 13px; margin: 0 0 10px 0;">3 Piezas de pollo broster + 2 Salchipapas personales + Gaseosa familiar de 1.5 Litros.</p>
                                                </td>
                                                <td width="90" align="right" valign="middle">
                                                    <span style="color: #FFB703; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;">S/. 45.00</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
export const COMBO_PROMO_TEMPLATE = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>¡2x1 en Combos de Salchipapas y Pollo! </title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f4f5; font-family: 'Segoe UI', Arial, sans-serif; color: #1f2937;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f4f4f5; padding: 20px 0;">
        <tr>
            <td align="center">
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #0b0b0c; border-radius: 16px; overflow: hidden; border: 1px solid #27272a;">
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #FF8A33 0%, #FF6B00 100%); padding: 35px 20px;">
                            <span style="font-size: 45px; display: block; margin-bottom: 10px;"></span>
                            <h1 style="color: #ffffff; margin: 0; font-size: 26px; font-weight: 800; text-transform: uppercase;">¡SUPER PROMO 2X1!</h1>
                            <p style="color: #ffca3a; margin: 8px 0 0 0; font-size: 14px; font-weight: bold;">Salchipapas y Pollo Crujiente al Duplicado</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 35px 25px; background-color: #121214;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px; background-color: #1c1c1f; border-radius: 12px; border: 1px solid #27272a; padding: 15px;">
                                <tr>
                                    <td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px; background-color: #1c1c1f; border-radius: 12px; border: 1px solid #27272a; padding: 15px;">
                                <tr>
                                    <td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <a href="https://wa.me/51960373555?text=Hola!%20Quiero%20la%20promocion%202x1" target="_blank" style="background: linear-gradient(135deg, #FF6B00 0%, #FF8A33 100%); color: #ffffff; display: inline-block; font-size: 14px; font-weight: bold; text-decoration: none; padding: 12px 30px; border-radius: 50px; text-transform: uppercase;">
                                            🟢 Pedir 2x1 por WhatsApp
                                        </a>
                                    </td>
                                </tr>
                            </table>
...
export const WEEKEND_PROMO_TEMPLATE = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f4f4f5; padding: 20px 0;">
        <tr>
            <td align="center">
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #0b0b0c; border-radius: 16px; overflow: hidden; border: 1px solid #27272a;">
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #FFB703 0%, #FF6B00 100%); padding: 35px 20px;">
                            <span style="font-size: 45px; display: block; margin-bottom: 10px;"></span>
                            <h1 style="color: #ffffff; margin: 0; font-size: 26px; font-weight: 800; text-transform: uppercase;">FIN DE SEMANA DE LOCURA</h1>
                            <p style="color: #ffffff; margin: 8px 0 0 0; font-size: 14px; font-weight: 500;">El Sabor que tu Fin de Semana se Merece</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 35px 25px; background-color: #121214;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px; background-color: #1c1c1f; border-radius: 12px; border: 1px solid #27272a; padding: 15px;">
                                <tr>
                                    <td>
                                        <h4 style="color: #ffffff; font-size: 15px; margin: 0 0 5px 0;">Combo Tiempo Extra ⏱️ + Gaseosa Gratis</h4>
                                        <p style="color: #a0a0a8; font-size: 12px; margin: 0;">4 Piezas de pollo broster crocante + Papas familiares + Ensalada + Gaseosa familiar de 1.5L.</p>
                                    </td>
                                    <td width="90" align="right" valign="middle">
                                        <span style="color: #FFB703; font-size: 18px; font-weight: bold;">S/. 49.90</span>
                                        <br><span style="color: #888; font-size: 10px; text-decoration: line-through;">S/. 55.00</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <a href="https://wa.me/51960373555?text=Hola!%20Quiero%20la%20promocion%20de%20fin%20de%20semana" target="_blank" style="background: linear-gradient(135deg, #FFB703 0%, #FF6B00 100%); color: #ffffff; display: inline-block; font-size: 14px; font-weight: bold; text-decoration: none; padding: 12px 30px; border-radius: 50px; text-transform: uppercase;">
                                            🟢 Hacer Pedido de Fin de Semana
                                        </a>
                                    </td>
                                </tr>
                            </table>
